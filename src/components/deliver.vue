            ...
            <div class="after-text">
                <div class="texter">
                    ...
                    <div class="colomn">
                        ...
                        <p>Всього 3 хвилини та піца готова. Ми приймаємо виклик і готові поборотися за рекорд Гіннеса. Наші досягнення: гаряча піца на свіжому тісті в дров’яній печі з суворо відібраних продуктів, автоматизована система замовлення та високий рівень сервісу. </p>
                    </div>
                </div>
            </div>
        </div>
...
<style lang="scss" scoped>
    .after-text{padding: 25px 0;}
    .texter{ padding: 25px; background-color: #fff;
